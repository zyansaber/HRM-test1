...
export const DepartmentSidebar = ({ 
  ...
  return (
    <Card className="h-full shadow-xl border border-gray-200 rounded-lg bg-gradient-to-b from-white to-gray-50/50">
      ...
      <CardContent className="p-0">
        <div className="space-y-2 p-4">
          ...
          {departments.map((dept) => {
            const paymentPercentage = totalPayments > 0 ? (dept.paymentAmount / totalPayments * 100) : 0;
              ...
              >
                <div className="flex flex-col items-start w-full space-y-2">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <div
                      className={`w-3 h-3 rounded-full ${getBudgetColor(dept.budgetUtilization)}`}
                  ...
                  <div className="grid grid-cols-2 gap-2 w-full text-xs">
                    <div className="text-left">
                      ...
                      <div className="font-medium">{paymentPercentage.toFixed(1)}%</div>
                    </div>
                    <div className="text-right">
                      <div className="opacity-80">vs Budget</div>
                      <div className="font-medium">{dept.budgetUtilization.toFixed(1)}%</div>
                    </div>
                  </div>
